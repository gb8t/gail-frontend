	...
	return (
		<div className='container'>
			...
			<form>
				...
				<input name='nascimento' type='date'   ref={inputNascimento} placeholder='Data de nascimento'/>
				<input name='altura'     type='number' ref={inputAltura}     placeholder='Altura (cm)' min="0"/>
				<input name='peso'       type='number' ref={inputPeso}       placeholder='Peso (kg)'   min="0"/>
				<select name='raca'      type='text'   ref={inputRaca}>
				...
				<select name='regiao'    type='text'   ref={inputRegiao}>
